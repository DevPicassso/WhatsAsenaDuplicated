...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'cg ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
        ...
        if (match[1] === '') {
            ...
            await message.client.sendMessage(
                message.jid,'●▬▬▬ *Champions Gang Hizmetinde* ▬▬▬●\n\n' + CMD_HELP, MessageType.text
            );    
        } else {
    ...
    Asena.addCommand({pattern: 'cg ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
